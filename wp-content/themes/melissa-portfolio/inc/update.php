...
class Update
{
    ...
    public function __construct($data) {
        ...
        $this->data = $args;
        add_filter( 'pre_set_site_transient_update_themes', array(  $this, 'melissa_portfolio_updates'  ) );
        add_filter( 'http_request_args', array(  $this, 'http_request_args'   ), 10, 2);
    }

    public function melissa_portfolio_updates($data) {
        $theme_dtls = array(
...
$data        = array(
    'user'  => 'domainlee',
    'repo'  => 'melissa-portfolio',
    'token' => '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'
);
new Update($data);