            ...
            if( !empty($options['type']) ){
                switch ($options['type']) {
                    ...
                    case 'color':
                        ...
                        <div class="color-mienle <?php echo esc_attr(isset($options['class']) ? $options['class']:''); ?>" <?php if( !empty( $style_to_add ) ) { echo 'style="'.esc_attr( $style_to_add ).'"';} ?>>
		...
		protected function render() {
			...
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="melissa_portfolio_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
				<h3 class="accordion-section-title" tabindex="0" style="">
					...
					<a href="<?php echo esc_url( $this->url ); ?>" class="button button-secondary alignright" target="_blank" style="margin-top: -3px;"><?php echo esc_html( $this->button_text ); ?></a>
				</h3>
			</li>
			<?php
		}
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Melissa_Portfolio_WP_Customize_TinyMCE_Control extends WP_Customize_Control {
        /**
         * The type of control being rendered
         */
