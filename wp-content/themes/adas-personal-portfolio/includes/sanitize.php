 ...
 */
function adas_personal_portfolio_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function adas_personal_portfolio_sanitize_css( $css ) {
 ...
 */
function adas_personal_portfolio_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function adas_personal_portfolio_sanitize_image( $input, $setting ) {
	return esc_url_raw( adas_personal_portfolio_validate_image( $input, $setting->default ) );
}
...
function adas_personal_portfolio_validate_image( $input, $default = '' ) {
 ...
 */
function adas_personal_portfolio_sanitize_number_absint( $number, $setting ) {
 ...
 */
function adas_personal_portfolio_sanitize_select( $input, $setting ) {
 ...
 * @return int
 */
function adas_personal_portfolio_sanitize_category($input){
	$output=intval($input);
	return $output;
}
